...
void main() {
  // Membuat produk
  var produk1 = Produk('Motif Brawijaya', 180000, 10);
  var produk2 = Produk('Motif Astungkara', 150000, 5);
  var produk3 = Produk('Motif Prabujoyo', 170000, 7);
